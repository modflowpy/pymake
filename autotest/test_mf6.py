...
@pytest.mark.dependency(name="makefile", depends=["download"])
@pytest.mark.base
def test_makefile():
...
@pytest.mark.dependency(name="shared", depends=["download"])
@pytest.mark.base
...
@pytest.mark.dependency(name="shared_makefile", depends=["download"])
@pytest.mark.base
